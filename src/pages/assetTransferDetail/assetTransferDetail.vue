<template>
    <div class="layer-voucher-detail">
      <div class="form-voucher-detail">
        <div class="form-header-voucher-detail">
          <div class="form-title-voucher-detail">{{ 'Điều chuyển tài sản cố định' }}</div>
          <div class="blank"></div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        voucherAPI: config.AssetTransferAPI,
        voucherTh: resource.voucherTh,
        voucherDetailThForm: resource.assetTransferDetailTH,
  ...
  <style scoped>
  @import url(./assetTransferDetail.css);
  </style>
