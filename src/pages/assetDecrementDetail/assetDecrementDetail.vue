<template>
    <div class="layer-voucher-detail">
      <div class="form-voucher-detail">
        <div class="form-header-voucher-detail">
          <div class="form-title-voucher-detail">Ghi giảm tài sản</div>
          <div class="blank"></div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        voucherAPI: config.assetDecrementAPI,
        voucherTh: resource.voucherTh,
        voucherDetailThForm: resource.assetDecrementDetailThForm,
  ...
  <style scoped>
  @import url(./assetDecrementDetail.css);
  </style>
