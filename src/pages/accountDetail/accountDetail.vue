            ...
            <div class="form-body-product">
                ...
                <div class="form-product-left-2">
                    ...
                    <MInput
                        ...
                        :important="true" 
                        :alowNull="false"
                        v-model="this.ProductInfo.account_number"    
                        :alowDisabled="false"  
                    ...
                    <MCombobox
                        api="https://localhost:7210/api/AccountSystems"
                        ...
                        :important="true"
                        :alowNull="false"
                        v-model="this.ProductInfo.account_number_parent"
                        :isEmpty="isDepartmentCodeEmpty"
                        @result="CheckDepartmentCodeEmpty"
                        entityEmit="account_number"
                        @dataEmit="autoSelect($event, 'https://localhost:7210/api/AccountSystems/Info/', 'account_number_parent_name', 'account_number_parent_name', 'account_name')"
                    ...
                    <MNumberInput
                        ...
                        :important="true"
                        :alowNull="false"
                        v-model="ProductInfo.account_type"
                        :tabindex="5"
                        :maxlength="15"
                    ></MNumberInput>
                    <!-- input chứa số lượng -->
                ...
                -->
                <div class="form-product-right-2">

                    <!-- input tên tài sản -->
                    <MInput
                        :fieldLabel="'Tên tài khoản'"   
                        v-model="this.ProductInfo.account_name"   
                        :alowNull="false"     
                        :alowDisabled="false"  
                        :important="true"   
                    ...
                    <MInput
                        :fieldLabel="'Tên nhóm tài khoản'"            
                        :alowDisabled="true"      
                        :alowNull="true"
                        class="department-use-input-product"
                        v-model="ProductInfo.account_number_parent_name"
                    ></MInput>
                    ...
                    <div class="price-count-year-product">
                        ...
                        <div class="price-count-product">
                            ...
                            <MNumberInput
                                ...
                                :important="false"
                                :alowNull="false"
                                v-model="ProductInfo.debit_amount"
                                :tabindex="6" 
                                :maxlength="15"
                            ></MNumberInput>
                        ...
                        <div 
                            ...
                            <MNumberInput
                                ...
                                :important="false"
                                :alowNull="false"
                                v-model="ProductInfo.credit_amount" 
                                :tabindex="7" 
                                :maxlength="15"
                            ></MNumberInput>
...
export default {
    ...
    components: {
        MInput, MCombobox, MButton, MNumberInput, MPopup, MTooltip
    },
    methods: {
        /**
        ...
        addAsset() {
                this.$emit('startLoading');
                axios.post('https://localhost:7210/api/AccountSystems', {
                    "account_number": this.ProductInfo.account_number,
                    "account_name": this.ProductInfo.account_name,
                    "account_number_parent": this.ProductInfo.account_number_parent ?? '',
                    "account_type": this.ProductInfo.account_type,
                    "debit_amount": this.ProductInfo.debit_amount,
                    "credit_amount": this.ProductInfo.credit_amount,
                    "description": this.ProductInfo.description,
                    "is_parent": this.ProductInfo.account_number_parent ? 0 : 1
                })
                .then(res => {
                    if(res.data >= 1) {
    ...
    created() {
        ...
        if(this.dataForEdit != null) {
            // Gọi API lấy product theo id
                axios
                    .get('https://localhost:7210/api/AccountSystems/Info/' + this.dataForEdit)
                    .then(res => 
                        {
                            (this.ProductInfo.account_number = res.data[0].account_number),
                            (this.ProductInfo.account_number_parent = res.data[0].account_number_parent),
                            (this.ProductInfo.account_type = res.data[0].account_type),
                            (this.ProductInfo.account_name = res.data[0].account_name),
                            (this.ProductInfo.account_number_parent_name = res.data[0].account_number_parent_name),
                            (this.ProductInfo.debit_amount = res.data[0].debit_amount),
                            (this.ProductInfo.credit_amount = res.data[0].credit_amount),
                            (this.ProductInfo.description = res.data[0].description)
