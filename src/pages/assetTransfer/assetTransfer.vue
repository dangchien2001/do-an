<template>
    ...
    >
        <div class="asset-header">
            <div class="title-asset">Điều chuyển tài sản cố định</div>
...
import assetTransferDetail from '../assetTransferDetail/assetTransferDetail.vue'
...
export default {
    ...
    components: {
        MButton, MIconButton, MInputWithIcon, Splitpanes, Pane, MTable, assetTransferDetail, MListAssetNoActive, MPopup, MLoadingTiny, MTooltip, ReportPopup
    },
    async created() {
    ...
    data() {
        return {
            ...
            voucherTh: resource.assetTransferTH,
            voucherDetailTh: resource.assetTransferDetailTH,
