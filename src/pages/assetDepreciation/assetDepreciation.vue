<template>
    ...
    >
        <div class="asset-header">
            <div class="title-asset">Tính hao mòn</div>
...
import assetDepreciationDetail from '../assetDepreciationDetail/assetDepreciationDetail.vue'
...
export default {
    ...
    components: {
        MButton, MIconButton, MInputWithIcon, Splitpanes, Pane, MTable, assetDepreciationDetail, MListAssetNoActive, MPopup, MLoadingTiny, MTooltip, ReportPopup
    },
    async created() {
    ...
    data() {
        return {
            ...
            voucherTh: resource.assetDepreciationTH,
            voucherDetailTh: resource.assetDepreciationDetailTH,
...
<style scoped>
@import url(./assetDepreciation.css);
</style>