<template>
    ...
    >
        <div class="asset-header">
            <div class="title-asset">Ghi giảm</div>
...
import assetDecrementDetail from '../assetDecrementDetail/assetDecrementDetail.vue'
...
export default {
    ...
    components: {
        MButton, MIconButton, MInputWithIcon, Splitpanes, Pane, MTable, assetDecrementDetail, MListAssetNoActive, MPopup, MLoadingTiny, MTooltip, ReportPopup
    },
    async created() {
    ...
    data() {
        return {
            ...
            voucherTh: resource.assetDecrementTH,
            voucherDetailTh: resource.assetDecrementDetailThForm,
