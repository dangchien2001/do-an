<template>
  ...
  >
    ...
    <table :class="[typeTable, 'table']" id="table">
      <!-- header -->
      <tr :class="['table-header', boldRow ? 'bold-row' : '']">
        <!-- first/checkbox col -->
        <th
        ...
        >
          {{ item.colName }}
          <MTooltip
            v-if="item.tooltipText != undefined"
      ...
      <tr class="footer-content" v-if="footer == 'oldFooter'">
        ...
        <td :colspan="'6'">
          ...
          <div class="footer-content-function">
            ...
            <div class="list-page">
              <!-- pre button -->
              <div
                class="list-page-pre-button"
                @click="NextAndReturnPage('pre')"
              >
                <!-- pre button icon -->
              ...
              >
                ...
                <div
                  :class="[
                    'page',
                    { 'page-active': i + PageIndex - 1 == activePage },
                  ]"
                  v-for="i in 3"
                  :key="i"
              ...
              <div
                class="pagging-box"
                v-if="typePaging == 'long' && PageIndex > totalPage - 3"
              >
                <div
                  :class="['page', { 'page-active': 1 == activePage }]"
                  @click="SelectPage(1)"
                ...
                <div
                  :class="[
                    'page',
                    { 'page-active': totalPage - 2 == activePage },
                  ]"
                ...
                <div
                  :class="[
                    'page',
                    { 'page-active': totalPage - 1 == activePage },
                  ]"
              ...
              <!-- next button -->
              <div
                class="list-page-next-button"
                @click="NextAndReturnPage('next')"
              >
                <!-- next button icon -->
        ...
        <!-- HM-KH -->
        <td class="HM-KH">
          {{ this.formatMoney(TotalAccumulatedDepreciation) }}
        </td>
    ...
    <!-- footer-->
    <table
      v-if="footer == 'newFooter'"
      style=""
      :class="['footer-table-v2', boldRow ? 'bold-row' : '']"
    >
      <tr>
      ...
      <tr style="height: 39px">
        <td :colspan="colspan">
          ...
          <div class="footer-content-function">
            <div
              v-if="!allowPaging"
              style="margin-left: 10px; font-family: 'Roboto Bold'"
            >
              Tổng
            </div>
            ...
            <div class="text-of-data" v-if="allowPaging">
              {{ paging.record }}
            </div>
            ...
            <div class="list-page" v-if="allowPaging">
              ...
              <div
                :class="[
                  activePage == 1
                    ? 'list-page-pre-button-disable'
                    : 'list-page-pre-button',
                ]"
                @click="NextAndReturnPage('pre')"
              >
                <!-- pre button icon -->
        ...
        <td
          ...
          :key="index"
          style="text-align: right; font-family: Roboto Bold"
        >
          {{ this.formatMoney(item) }}
        </td>
        <td
          v-for="n in tableInfo.length - colspan - moreInfo.length + 1"
          :key="n"
        ></td>
      </tr>
    </table>
...
export default {
        ...
        .then((res) => {
          (this.totalPage = res.data.TotalPage),
            ...
            (this.TotalAccumulatedDepreciation =
              res.data.TotalDepreciationValue),
  ...
  methods: {
    ...
    handleSelectAll(value) {
      if (value == true) {
        ...
        this.$emit(
          "listAssetForDelete",
          Object.values(this.listAssetForDelete)
        );
  ...
  watch: {
    ...
    callApiAfterIdChange: function (newValue) {
      ...
      axios.get(this.api + newValue).then((res) => {
        this.unSelectRow(),
          (this.isCheckboxHeaderSelect = false),
          (this.ActivePage = 1),
          (this.data2 = res.data),
